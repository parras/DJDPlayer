...
import nu.staldal.djdplayer.CategoryFragment;
import nu.staldal.djdplayer.CreatePlaylist;
import nu.staldal.djdplayer.ExportPlaylistTask;
import nu.staldal.djdplayer.MusicUtils;
import nu.staldal.djdplayer.PlaylistShortcutActivity;
...
public class GoogleMusicPlaylistFragment extends CategoryFragment {
    private static final String LOGTAG = "GoogleMusicPlaylistFragment";
        ...
        listAdapter.setViewBinder((view, cursor, columnIndex) -> {
            switch (view.getId()) {
                case R.id.line2:
                    ...
                    ((TextView) view).setText(GoogleMusicPlaylistFragment.this.getActivity().getResources()
        ...
        switch (item.getItemId()) {
                ...
                if (currentId == MusicContract.Playlist.RECENTLY_ADDED_PLAYLIST) {
                    new AlertDialog.Builder(getActivity())
                            ...
                            .setItems(R.array.weeklist, (dialog, which) -> {
                                ...
                                MusicUtils.setIntPref(GoogleMusicPlaylistFragment.this.getActivity(), SettingsActivity.NUMWEEKS,
                                        numweeks);
                                getLoaderManager().restartLoader(0, null, GoogleMusicPlaylistFragment.this);
                            }).show();
                } else {
            ...
            case R.id.playlist_rename_playlist: {
                ...
                if (playlistId >= 0 && playlistName != null) {
                    ...
                    new AlertDialog.Builder(getActivity())
                            .setTitle(String.format(GoogleMusicPlaylistFragment.this.getString(R.string.rename_playlist_prompt),
                                    playlistName))
                            .setView(view)
                            .setNegativeButton(R.string.cancel, (dialog, which) -> { })
